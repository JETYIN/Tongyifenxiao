package cn.qmz.tools.view.shaploading;
...
/**
 * ShapeLoadingView 仿58同城加载效果   从圆变方再变三角
...
public class LoadingView  extends FrameLayout {
	...
	protected void onFinishInflate() {
		...
		View view=  LayoutInflater.from(getContext()).inflate(R.layout.shape_loading_view, null);
